      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={[styles.toggleCard, { backgroundColor: theme.colors.surface, borderColor: theme.colors.border }]}>
          <View style={styles.toggleLeft}>
            <View style={[styles.statusDot, { backgroundColor: wifiEnabled ? '#22c55e' : '#ef4444' }]} />
            <View>
              ...
              <Text style={[styles.toggleSub, { color: theme.colors.textSecondary }]}>
                {wifiEnabled ? 'Active — Broadcasting' : 'Disabled'}
              </Text>
            </View>
          </View>
          <Switch
            ...
            thumbColor={wifiEnabled ? '#3b82f6' : '#64748b'}
          />
        </View>
        ...
        {!wifiEnabled && (
          <View style={styles.wifiDisabledWarning}>
            <Text style={styles.wifiDisabledIcon}>📶</Text>
            <View style={styles.wifiDisabledText}>
              <Text style={styles.wifiDisabledTitle}>Wi-Fi is Disabled</Text>
              <Text style={styles.wifiDisabledDesc}>
                Enable Wi-Fi to scan for nearby networks and connect.
              </Text>
            </View>
          </View>
        )}
